...
CFG.REVIEWKD.SHAPES = [128, 64, 32]
CFG.REVIEWKD.OUT_SHAPES = [128, 64, 32]
CFG.REVIEWKD.IN_CHANNELS = [32, 64, 128]
CFG.REVIEWKD.OUT_CHANNELS = [32, 64, 128]
CFG.REVIEWKD.MAX_MID_CHANNEL = 256
