...
class ComputeLoss:
    ...
    def __init__(
        ...
        self.formal_assigner = TaskAlignedAssigner(topk=13, num_classes=self.num_classes, alpha=1.0, beta=6.0, gamma=1.0,max_epoch=self.max_epoch)
        # self.formal_assigner = TaskAlignedAssigner(
        #     topk=13, num_classes=self.num_classes, alpha=1.0, beta=6.0 ,max_epoch = self.max_epoch
        # )  # NOTE TAL
