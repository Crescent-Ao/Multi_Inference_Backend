...
class TaskAlignedAssigner(nn.Module):
    def __init__(self, topk=13, num_classes=80, alpha=1.0, beta=5.0, gamma = 3.0,eps=1e-9, max_epoch=500):
        ...
        self.lut_angle, self.lut_index, self.lut_iou = self.initialize_lut(point_nums=400)
    @torch.no_grad()
    ...
    def lut_angle_measure(self, pd_angles, gt_angles, gt_bboxes,point_num=400):
        """
        ...
        lut_theta_index = torch.clip(theta_diff,0.0,180.0)*point_num/180
